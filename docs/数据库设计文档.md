...
flowchart LR
    subgraph 主文章（中文）
        A1[文章ID: 1<br/>locale: zh-CN<br/>master_article_id: NULL]
    end
    
    subgraph 翻译版本
        A2[文章ID: 2<br/>locale: en-US<br/>master_article_id: 1]
        A3[文章ID: 3<br/>locale: ja-JP<br/>master_article_id: 1]
    end
...
graph TB
    subgraph 网站层
        SITE[gb_sites<br/>网站]
        LOCALE[gb_site_locales<br/>语言配置]
    end
    ...
    subgraph AI任务层
        BATCH[gb_ai_batch_tasks<br/>批量任务]
