...
export const FixNavbarConfig = (submodule: string) => navbar([
  addActiveMatch({
    text: "首页",
    link: "/redirect?tourl=/zh-CN/",
    icon: "lightbulb",
  }, submodule),
  addActiveMatch({
    text: "游戏破解版",
    link:  "/redirect?tourl=/zh-CN/pojie/",
    icon: "lightbulb",
  }, submodule),
  addActiveMatch({
    text: "游戏攻略",
    link:  "/redirect?tourl=/zh-CN/strategy/",
    icon: "lightbulb",
    children: [
          {
            text: "历史文章",
            icon: "code",
            link: "/redirect?tourl=/zh-CN/strategy/",
            activeMatch: "^/zh-CN/strategy/$",
          },
          {
            text: "2025年11月",
            icon: "code",
            link: "/redirect?tourl=/zh-CN/strategy/2025/11/",
            activeMatch: "^/zh-CN/strategy/2025/11/$",
          },
      {
        text: "2025年12月",
        icon: "code",
        link: "/redirect?tourl=/zh-CN/strategy/2025/12/",
        activeMatch: "^/zh-CN/strategy/2025/12/$",
      },
        ],
  }, submodule),
]);
