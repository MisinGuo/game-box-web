...
export function BoxCard({ name, logoColor, logoText, description, tags, gameCount, rating, discount }: BoxCardProps) {
  return (
    <Card className="bg-slate-900 border-slate-800 hover:border-slate-700 transition-all hover:shadow-lg hover:shadow-blue-900/10 group">
      <CardContent className="p-5 flex flex-col md:flex-row gap-6 items-start md:items-center">
        ...
        <div className="flex flex-row md:flex-col gap-3 w-full md:w-auto shrink-0 mt-2 md:mt-0">
          <Button className="flex-1 md:w-32 bg-blue-600 hover:bg-blue-700 font-semibold shadow-lg shadow-blue-900/20">
            进入盒子
          </Button>
          <Button variant="outline" className="flex-1 md:w-32 border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white">
